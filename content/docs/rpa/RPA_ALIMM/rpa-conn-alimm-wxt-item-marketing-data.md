---
title: 万相台-报表-商品营销数据
description: 导出阿里妈妈万相台（UD智汇投）商品营销数据报表，支持按营销场景、投放媒体、汇总周期及投放商品类目筛选
entry: rpa.conn.alimm.wxt.item.marketing.data
badge:
  label: 待上线
  color: "#EA580C"
estimatedDuration:
...
| ---------------- | ------------------------------------------------------------------ |
| **连接器类型**   | `RPA 连接器`                                                       |
| **连接器名称**   | `ODS_万相台报表商品营销数据明细表(阿里妈妈RPA)`                    |
| **连接器代码**   | `rpa.conn.alimm.wxt.item.marketing.data`                            |
| **操作类型**     | `文件导出`                                                         |
| **目标网页**     | `https://ud.alimama.com/index.html#!/report/launchItem?rptType=launchItem` |
| **适用场景**     | 导出阿里妈妈万相台（UD智汇投）商品营销数据报表，支持按营销场景、投放媒体、汇总周期及投放商品类目筛选 |
| **数据表名**     | `ods_rpa_alimm_wxt_item_marketing_data_du`                          |
| **业务表名**     | `ODS_万相台报表商品营销数据明细表(阿里妈妈RPA)`                    |
...
![阿里妈妈—UD智汇投商品营销数据](../_public/images/alimm/wxt_item_marketing_data_20260721.png)
