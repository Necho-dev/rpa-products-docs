...
| **数据表名**     | `ods_rpa_alimm_wxt_item_violation_du`|
| **业务表名**     | `ODS_万相台商品违规明细表(阿里妈妈RPA)`|

### 目标页面

> **取数路径**：阿里妈妈—万相台—账户—违规管理—内容违规—商品
>
> **取数链接**：[https://one.alimama.com/index.html#!/account/violation/index?tab=content&tabIndex=item](https://one.alimama.com/index.html#!/account/violation/index?tab=content&tabIndex=item)

![阿里妈妈—万相台商品违规列表](../../_public/images/alimm/item_violation_20260604.png)
