...
![生意参谋—商品排行全部数据下载](../_public/images/sycm/rank_all_20260429.png)
...
| `mainProductId` | 主商品 ID | `Number` | 否 | `XLS.0.主商品ID` | `988****428` (已脱敏) |
...
| `taskId` | 任务 ID | `String` | 否 | 附加 | `dev****8a7` (已脱敏) |
| `bizDate` | 业务日期 | `String` | 否 | 附加 | 20260413 |
