...
> **路径**：阿里妈妈—品牌新享—数据中心—超级会员加速
>
> **网址**：[https://ppxk.tmall.com/new/index.htm#!/data-center/memacc/index](https://ppxk.tmall.com/new/index.htm#!/data-center/memacc/index)
...
```json
{
    "name": "rpa.conn.alimm.ppxx.data.center.memacc.index",
