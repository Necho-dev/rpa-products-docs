...
| `rankAvgDescRevScr1m`                   | 描述评分排名（三级类目）         | `number` | 否     | `goodsNavigatorDetailDTO.rankAvgDescRevScr1m`                 | `0.4727`                                                                                         |
| `rankAvgDescRevScr1mStage`              | 描述评分排名阶段（三级类目）     | `number` | 否     | `goodsNavigatorDetailDTO.rankAvgDescRevScr1mStage`            | `3`                                                                                              |
| `rankAvgDescRevScr1mStpl`               | 描述评分排名（主营类目）         | `number` | 否     | `goodsNavigatorDetailDTO.rankAvgDescRevScr1mStpl`             | `0.7194`                                                                                         |
| `rankAvgDescRevScr1mStplStage`          | 描述评分排名阶段（主营类目）     | `number` | 否     | `goodsNavigatorDetailDTO.rankAvgDescRevScr1mStplStage`        | `4`                                                                                              |
...
| `rankQltyRfndOrdrCntRto1mStage`         | 品质退款率排名阶段（三级类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankQltyRfndOrdrCntRto1mStage`       | `4`                                                                                              |
| `rankQltyRfndOrdrCntRto1mStpl`          | 品质退款率排名（主营类目）       | `number` | 否     | `goodsNavigatorDetailDTO.rankQltyRfndOrdrCntRto1mStpl`        | `1.0`                                                                                            |
| `rankQltyRfndOrdrCntRto1mStplStage`     | 品质退款率排名阶段（主营类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankQltyRfndOrdrCntRto1mStplStage`   | `4`                                                                                              |
| `ptHelpPzRate30d`                       | 近 30 天求助平台率               | `number` | 否     | `goodsNavigatorDetailDTO.ptHelpPzRate30d`                     | `0.0`                                                                                            |
| `rankPtHelpPzRate30d`                   | 求助平台率排名（三级类目）       | `number` | 否     | `goodsNavigatorDetailDTO.rankPtHelpPzRate30d`                 | `0.9937`                                                                                         |
| `rankPtHelpPzRate30dStage`              | 求助平台率排名阶段（三级类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankPtHelpPzRate30dStage`            | `4`                                                                                              |
| `rankPtHelpPzRate30dStpl`               | 求助平台率排名（主营类目）       | `number` | 否     | `goodsNavigatorDetailDTO.rankPtHelpPzRate30dStpl`             | `0.9956`                                                                                         |
| `rankPtHelpPzRate30dStplStage`          | 求助平台率排名阶段（主营类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankPtHelpPzRate30dStplStage`        | `4`                                                                                              |
| `midRto30d`                             | 近 30 天文本情感分               | `number` | 否     | `goodsNavigatorDetailDTO.midRto30d`                           | `5.0`                                                                                            |
| `rankComscoreStage`                     | 文本情感分排名阶段（三级类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankComscoreStage`                   | `4`                                                                                              |
| `rankComscoreStplStage`                 | 文本情感分排名阶段（主营类目）   | `number` | 否     | `goodsNavigatorDetailDTO.rankComscoreStplStage`               | `4`                                                                                              |
